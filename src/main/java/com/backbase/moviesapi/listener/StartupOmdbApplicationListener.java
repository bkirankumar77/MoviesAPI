package com.backbase.moviesapi.listener;

import com.backbase.moviesapi.enums.Type;
import com.backbase.moviesapi.service.ConfigOmdbService;
import com.backbase.moviesapi.service.MovieService;
...
public class StartupOmdbApplicationListener implements
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        try (var reader = new CSVReader(new FileReader(ResourceUtils
            .getFile(moviesDataFileURL)))) {
            Optional.of(reader.readAll()).flatMap(list -> Optional.of(list.iterator()))
                .ifPresent(it -> {
                    try {
